...
;LLCD_cnt_h: ds 1 ; reserve 1 byte for variable LCD_cnt_h
...
;All_bits: ds 1
;
;CD_cnt_l: ds 1 ; reserve 1 byte for variable LCD_cnt_l

psect LEDchange_code class=CODE
...
numIsPositive:
 ...
 movff num_LEDS_to_change, PORTC, A ; if no change needed, branch back
 bz keypadCheck
...
continue_Rotate:
 movf num_LEDS_to_change, W, A
 bz keypadCheck ; finished changing LEDs
