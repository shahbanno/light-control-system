...
ADC_Setup:
 bsf TRISA, PORTA_RA0_POSN, A ; pin ((PORTA) and 0FFh), 0, a==((PORTA) and 0FFh), 0, a input
 movlb 0x0f
 bsf ((ANCON0) and 0FFh), 0, b ; set ((PORTA) and 0FFh), 0, a to analog
 movlb 0x00
 movlw 0x01 ; select ((PORTA) and 0FFh), 0, a for measurement
...
adc_loop:
 btfsc ((ADCON0) and 0FFh), 1, a ; check to see if finished
 bra adc_loop
 return
